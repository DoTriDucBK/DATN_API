...
export default class UserController {
    ...
    public putLogin = async (req: Request, res: Response) => {
        console.log("login user by username and password => PUT")
    ...
    public postSignup = async (req: Request, res: Response) => {
        ...
        if (((!req.body.emailUser) && (!req.body.telUser)) || (!req.body.password)) MyUtil.handleError({ message: "Bạn chưa nhập đủ thông tin" }, res);
